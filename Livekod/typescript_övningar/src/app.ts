window.addEventListener('load', () : void => {
    ...
    // Övning 2
    // Inkommande datum måste se ut enl följande: YYYY-MM-DD
    ...
    // Övning Bibblan del 3

    console.log(getBookByTitle(books, 'mock'));

    function getBookByTitle(bookList : Book[], searchTerm : string) {
